...
if __name__ == '__main__':
    ...
    ack_sys, address_rec = the_socket.recvfrom(buf)
    print(ack_sys.decode(), "ACK_CONN", address_rec, address)
    if ack_sys.decode() == "ACK_CONN" and address_rec == address:
